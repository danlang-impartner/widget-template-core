...
namespace Impartner.Microservice.Training
{
	public class Startup
	{
		...
		public ServiceInfo ServiceInfo { get; } =
			new ServiceInfo { Title = "Training", Version = "V1" };
		...
		public void ConfigureServices(IServiceCollection services)
		{
			...
			services.AddScoped<ICertificationStatusUpdator, CertificationStatusUpdator>();
			services.AddScoped<ICourseCompletionHandler, CourseCompletionHandler>();
